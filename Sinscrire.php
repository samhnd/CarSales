...
<em> Vous recevrez la confirmation de votre inscription par mail. </em></br>
		...
		<form class="formulaire" method="post" action="creer.php">
			    <p>     
				    ...
				    <input type="email" name="mail" id="mail" placeholder="car&vip@mail.fr"  size="40" required />
				    </br></br>
                    ...
                    <strong><label for="codepostal">Code Postal :</label></strong></br>
		             ...
		             <strong><label for="identifiant">Identifiant :</label></strong></br>
                     <input id="identifiant" name="identifiant" type="id" placeholder="Minimum 6 caractères" required>
                     </br></br>
